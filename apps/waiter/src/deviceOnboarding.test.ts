...
describe('Waiter Device onboarding',()=>{
  it.each([
...
function props(state:DeviceOnboardingState){return {productLabel:'Waiter',state,displayName:'Waiter Terraza',pairingCode:'123456',
