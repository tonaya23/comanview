  ...
  it('renders the structured first Device authorization flow with contextual status and error', () => {
    const html = render(
      <InstallationAuthorizationPanel
        ...
        status={{
          authorizationId: '01991a00-0000-7000-8000-000000000501',
          status: 'ISSUED',
        ...
        busy={false}
        error="La autorización no coincide con esta solicitud."
        onClose={() => undefined}
        onSubmit={() => undefined}
      />,
    ...
    expect(html).toContain('Nombre del propietario inicial');
