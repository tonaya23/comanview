...
export type AuditAction =
  ...
  | 'BACKUP_REQUESTED' | 'BACKUP_VERIFIED' | 'BACKUP_FAILED' | 'BACKUP_RETENTION_DELETED'
  | 'RECOVERY_INITIATED' | 'RECOVERY_VALIDATED' | 'RECOVERY_COMPLETED' | 'RECOVERY_FAILED'
  | 'RECOVERY_REQUIRED_ENTERED' | 'RECOVERY_REQUIRED_EXITED' | 'RECOVERY_KEY_EXPORTED';
export type AuditEntityType =
  'CATEGORY' |
  'PAYMENT' | 'CASH_MOVEMENT' | 'CASH_REPORT' | 'CASH_SESSION' | 'ORDER' | 'DEVICE' | 'PAIRING' | 'INSTALLATION' | 'BACKUP' | 'RECOVERY' | 'TAX_PROFILE' | 'PRODUCT' | 'OPERATIONAL_CONFIGURATION' | 'USER' |
